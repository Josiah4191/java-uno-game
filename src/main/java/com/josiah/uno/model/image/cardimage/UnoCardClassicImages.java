package com.josiah.uno.model.image.cardimage;


import com.josiah.uno.model.cardgame.card.unocard.UnoCard;
import com.josiah.uno.model.cardgame.card.unocard.UnoSuit;
import com.josiah.uno.model.cardgame.card.unocard.UnoValue;
import com.josiah.uno.model.image.ImageLogger;
import com.josiah.uno.model.image.playerimage.PlayerImages;

import java.net.URL;
import java.util.*;

import static com.josiah.uno.model.cardgame.card.unocard.UnoSuit.*;
import static com.josiah.uno.model.cardgame.card.unocard.UnoValue.*;
...
public class UnoCardClassicImages {
    ...
    /*
        This constant UnoCard is used for the Deck image to be loaded. It's used for error handling. If the card
