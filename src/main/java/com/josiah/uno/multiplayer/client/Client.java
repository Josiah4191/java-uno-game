...
import com.josiah.uno.model.cardgame.unogame.*;
...
import com.josiah.uno.multiplayer.client.clientmessage.GameAction;
import com.josiah.uno.multiplayer.client.clientmessage.GameActionListener;
import com.josiah.uno.multiplayer.server.servermessage.*;
import com.josiah.uno.multiplayer.server.*;
...
public class Client implements GameActionListener {
    ...
    public void handleSetPlayableCards(String message) {
        ...
        List<UnoCard> playableCards = setPlayableCardEvent.getPlayableCards();
